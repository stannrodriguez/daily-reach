...
# ----- standing / lunging statics -----

POSES["runners_lunge"] = {
    "head": (1.25, 4.95),
    "paths": [
        [(1.1, 4.4), (0.9, 4.05), (0, 2.2)],                        # spine forward
        [(0, 2.2), (1.45, 1.7), (1.95, 0.15), (2.65, 0.12)],        # front leg
        [(0, 2.2), (-1.75, 1.15), (-3.3, 0.25), (-3.95, 0.15)],     # back leg long
        [(0.9, 4.05), (1.5, 2.4), (1.75, 0.15)],                    # fingertips down
        [(0.75, 3.98), (1.35, 2.35), (1.6, 0.12)],
    ],
    "ground": True,
}

POSES["low_lunge_opener"] = {
    "head": (0.28, 6.35),
    "paths": [
        [(0.25, 5.75), (0.15, 5.3), (0, 2.4)],
        [(0, 2.4), (1.4, 1.6), (1.5, 0.15), (2.2, 0.1)],            # front leg
        [(0, 2.4), (-1.6, 0.5), (-3.2, 0.3), (-3.8, 0.18)],         # back knee down
        [(0.15, 5.3), (0.75, 3.7), (1.3, 1.95)],                    # hands on front thigh
        [(0.02, 5.24), (0.6, 3.65), (1.15, 1.9)],
    ],
    "ground": True,
}

POSES["low_lunge_reach"] = {
    "head": (0.6, 6.4),
    "paths": [
        [(0.4, 5.82), (0.15, 5.3), (0, 2.4)],
        [(0, 2.4), (1.4, 1.6), (1.5, 0.15), (2.2, 0.1)],
        [(0, 2.4), (-1.6, 0.5), (-3.2, 0.3), (-3.8, 0.18)],
        [(0.15, 5.3), (-0.45, 6.6), (-0.95, 7.95)],                 # reach up and back
        [(0.15, 5.3), (-0.22, 6.78), (-0.62, 8.2)],
    ],
    "ground": True,
}
...
POSES["half_splits"] = {
    "head": (1.05, 1.75),
    "paths": [
        [(0.45, 1.95), (0.1, 2.1), (-1.4, 2.15)],                   # fold over the front leg
        [(-1.4, 2.15), (0.35, 1.15), (2.05, 0.15), (2.2, 1.0)],     # front leg straight, foot flexed
        [(-1.4, 2.15), (-1.6, 1.0), (-1.65, 0.3), (-3.35, 0.24)],   # hips back over back knee
        [(0.1, 2.1), (0.5, 1.1), (0.75, 0.18)],
        [(-0.02, 2.02), (0.35, 1.05), (0.58, 0.14)],
    ],
    "ground": True,
}
...
POSES["lizard"] = {
    "head": (1.5, 1.72),
    "paths": [
        [(0.85, 1.78), (0.55, 1.8), (-0.9, 1.55)],                  # torso low
        [(-0.9, 1.55), (1.5, 1.6), (2.15, 0.15), (2.85, 0.12)],     # front foot outside hand
        [(-0.9, 1.55), (-1.9, 0.55), (-2.6, 0.28), (-4.15, 0.2)],   # back knee down
        [(0.55, 1.8), (0.75, 0.4), (1.75, 0.25)],                   # onto the forearms
        [(0.42, 1.68), (0.6, 0.3), (1.6, 0.15)],
    ],
    "ground": True,
}
...
POSES["pyramid"] = {
    "head": (2.75, 1.95),
    "paths": [
        [(2.15, 2.25), (1.75, 2.55), (0, 3.5)],                     # long spine folding
        [(0, 3.5), (1.1, 1.8), (2.1, 0.15), (2.75, 0.12)],          # front leg straight
        [(0, 3.5), (-1.1, 1.8), (-2.1, 0.15), (-1.5, 0.12)],        # back foot at 45
        [(1.75, 2.55), (1.95, 1.35), (2.15, 0.18)],
        [(1.6, 2.48), (1.8, 1.3), (2.0, 0.15)],
    ],
    "ground": True,
}
...
POSES["side_angle"] = {
    "head": (2.05, 5.15),
    "paths": [
        [(1.6, 4.95), (1.2, 4.75), (0, 2.9)],                       # torso over front leg
        [(0, 2.9), (1.5, 1.6), (1.7, 0.18), (2.4, 0.15)],
        [(0, 2.9), (-1.3, 1.5), (-2.6, 0.22), (-3.3, 0.2)],
        [(1.2, 4.75), (1.55, 3.5), (1.9, 2.35)],                    # forearm to front thigh
        [(1.3, 4.9), (2.4, 6.05), (3.4, 7.05)],                     # top arm over the ear
    ],
    "ground": True,
}

POSES["reverse_warrior"] = {
    "head": (0.2, 6.95),
    "paths": [
        [(0.1, 6.35), (-0.05, 5.9), (0, 2.9)],
        [(0, 2.9), (1.5, 1.6), (1.7, 0.18), (2.4, 0.15)],           # front knee stays bent
        [(0, 2.9), (-1.3, 1.5), (-2.6, 0.22), (-3.3, 0.2)],
        [(-0.05, 5.9), (-0.75, 7.15), (-1.35, 8.3)],                # front palm up and over
        [(-0.1, 5.8), (-1.0, 4.55), (-1.7, 3.4)],                   # back hand down back leg
    ],
    "ground": True,
}

POSES["reverse_triangle"] = {
    "head": (2.9, 4.55),
    "paths": [
        [(2.4, 4.35), (2.0, 4.15), (0, 3.5)],                       # hips square, twist open
        [(0, 3.5), (1.15, 1.8), (2.2, 0.15), (2.9, 0.12)],
        [(0, 3.5), (-1.15, 1.8), (-2.2, 0.15), (-1.6, 0.12)],
        [(2.0, 4.15), (2.05, 2.3), (2.15, 0.4)],                    # hand outside front foot
        [(2.05, 4.3), (2.35, 5.85), (2.55, 7.3)],                   # top arm up
    ],
    "ground": True,
}
...
POSES["star"] = {
    ...
    "paths": [
        [(0, 7.15), (0, 6.7), (0, 3.7)],
        [(0, 3.7), (-1.15, 1.9), (-2.2, 0.12), (-2.7, 0.1)],        # feet wide
        [(0, 3.7), (1.15, 1.9), (2.2, 0.12), (2.7, 0.1)],
        [(0, 6.7), (-1.55, 7.0), (-3.05, 7.3)],                     # arms wide
        [(0, 6.7), (1.55, 7.0), (3.05, 7.3)],
    ],
    "ground": True,
}
...
POSES["wide_leg_fold"] = {
    "head": (0, 0.95),
    "paths": [
        [(0, 1.7), (0, 2.7), (0, 3.9)],                             # crown drops
        [(0, 3.9), (-1.75, 2.1), (-3.4, 0.12), (-3.85, 0.1)],       # feet wide and parallel
        [(0, 3.9), (1.75, 2.1), (3.4, 0.12), (3.85, 0.1)],
        [(0, 2.7), (-1.5, 1.75), (-2.0, 0.15)],                     # hands to the floor
        [(0, 2.7), (1.5, 1.75), (2.0, 0.15)],
    ],
    "ground": True,
}
...
POSES["ragdoll"] = {
    "head": (1.45, 1.1),
    "paths": [
        [(0, 3.3), (0.95, 2.6), (1.28, 1.75)],                      # heavy head
        [(0, 3.3), (0.92, 2.05), (0.25, 0.12), (0.9, 0.1)],         # knees softly bent
        [(0, 3.3), (0.62, 1.98), (0.0, 0.12), (0.6, 0.1)],
        [(1.28, 1.75), (1.18, 0.95), (1.08, 0.2)],                  # arms hang heavy
        [(1.14, 1.66), (1.02, 0.88), (0.92, 0.15)],
    ],
    "ground": True,
}

POSES["standing_split"] = {
    "head": (1.55, 0.95),
    "paths": [
        [(0, 3.7), (0.95, 2.85), (1.35, 1.6)],
        [(0, 3.7), (0.1, 1.85), (0.15, 0.12), (0.8, 0.1)],          # standing leg
        [(0, 3.7), (-0.95, 5.4), (-1.8, 7.05), (-2.05, 7.55)],      # lifted leg
        [(1.35, 1.6), (0.9, 0.95), (0.6, 0.22)],                    # hands frame the ankle
        [(1.2, 1.5), (0.75, 0.85), (0.45, 0.15)],
    ],
    "ground": True,
}
...
POSES["warrior3"] = {
    "head": (3.3, 4.05),
    "paths": [
        [(2.65, 3.98), (2.2, 3.95), (0, 3.7)],                      # torso parallel to floor
        [(0, 3.7), (0.1, 1.9), (0.15, 0.12), (0.8, 0.1)],           # standing leg
        [(0, 3.7), (-1.8, 3.75), (-3.5, 3.85)],                     # back leg level
        [(2.2, 3.95), (1.2, 3.5), (0.3, 3.1)],                      # arms swept back
        [(2.15, 3.82), (1.15, 3.35), (0.25, 2.95)],
    ],
    "ground": True,
}

POSES["figure4_standing"] = {
    "head": (0.5, 6.75),
    "paths": [
        [(0.45, 6.15), (0.3, 5.7), (-0.7, 3.1)],                    # hips sit back
        [(-0.7, 3.1), (0.55, 1.95), (0.25, 0.15), (0.95, 0.12)],    # standing leg
        [(-0.7, 3.1), (1.35, 2.9), (0.6, 1.85)],                    # ankle above the knee
        [(0.3, 5.7), (0.95, 4.4), (1.35, 3.35)],
        [(0.15, 5.62), (0.8, 4.35), (1.2, 3.3)],
    ],
    "ground": True,
}

POSES["standing_side_bend"] = {
    "head": (0.7, 7.6),
    "paths": [
        [(0.5, 7.0), (0.3, 6.55), (0, 3.7)],
        [(0, 3.7), (-0.35, 1.85), (-0.45, 0.12), (-0.9, 0.08)],
        [(0, 3.7), (0.35, 1.85), (0.45, 0.12), (0.9, 0.08)],
        [(0.3, 6.55), (1.65, 7.35), (2.7, 8.0)],                    # top arm reaches over
        [(0.25, 6.5), (-0.5, 5.4), (-0.35, 4.1)],                   # bottom hand to the hip
    ],
    "ground": True,
}

POSES["standing_backbend"] = {
    "head": (-0.55, 7.6),
    "paths": [
        [(-0.4, 7.0), (-0.15, 6.6), (0.15, 5.2), (0, 3.7)],         # length first
        [(0, 3.7), (0.05, 1.85), (0.1, 0.12), (0.75, 0.1)],
        [(0, 3.7), (-0.18, 1.85), (-0.18, 0.12), (0.45, 0.1)],
        [(-0.1, 6.4), (-0.85, 5.3), (-0.35, 4.05)],                 # hands to the low back
        [(0.05, 6.35), (-0.7, 5.25), (-0.2, 4.0)],
    ],
    "ground": True,
}
...
POSES["neck_side"] = {
    "head": (0.85, 7.45),
    "paths": [
        [(0.45, 6.95), (0, 6.7), (0, 3.7)],                         # ear toward the shoulder
        [(0, 3.7), (-0.3, 1.85), (-0.4, 0.12), (-0.85, 0.08)],
        [(0, 3.7), (0.3, 1.85), (0.4, 0.12), (0.85, 0.08)],
        [(0, 6.7), (1.35, 7.05), (1.5, 8.0)],                       # hand rests on the head
        [(0, 6.7), (-0.55, 5.3), (-0.65, 3.95)],
    ],
    "ground": True,
}
...
POSES["wall_chest"] = {
    ...
    "paths": [
        [(0.1, 7.1), (0, 6.7), (0, 3.7)],
        [(0, 3.7), (0.12, 1.85), (0.18, 0.12), (0.85, 0.1)],
        [(0, 3.7), (-0.15, 1.85), (-0.15, 0.12), (0.5, 0.1)],
        [(0, 6.7), (-1.0, 6.75), (-1.85, 6.8)],                     # arm back to the wall
        [(0, 6.7), (0.5, 5.35), (0.55, 4.0)],
    ],
    "props": [[(-2.05, 0.0), (-2.05, 8.6)],                         # wall
              [(-1.85, 6.8), (-1.85, 7.9)]],                        # forearm flat on it
    "ground": True,
}
...
POSES["thread_needle"] = {
    "head": (1.85, 0.75),
    "paths": [
        [(1.3, 0.85), (0.9, 1.15), (0, 2.0), (-1.4, 2.2)],          # temple to the mat
        [(-1.4, 2.2), (-1.5, 0.35), (-3.2, 0.28), (-3.8, 0.2)],     # hips stay high
        [(0.9, 1.15), (1.5, 0.3), (2.8, 0.2)],                      # threaded arm
        [(0.95, 1.3), (1.1, 2.5), (1.55, 3.5)],                     # top hand presses
    ],
    "ground": True,
}
...
POSES["straddle_fold"] = {
    "head": (0, 0.95),
    "paths": [
        [(0, 1.7), (0, 2.1), (0, 2.55)],                            # hinge from the hips
        [(0, 2.55), (-2.2, 1.05), (-4.2, 0.15), (-4.5, 0.72)],      # legs wide, toes up
        [(0, 2.55), (2.2, 1.05), (4.2, 0.15), (4.5, 0.72)],
        [(0, 2.1), (-1.05, 1.15), (-1.4, 0.35)],                    # hands walk forward
        [(0, 2.1), (1.05, 1.15), (1.4, 0.35)],
    ],
    "ground": True,
}
...
POSES["supine_ham"] = {
    "head": (-3.5, 0.82),
    "paths": [
        [(-2.95, 0.7), (-2.5, 0.68), (0, 0.72)],
        [(0, 0.72), (0.25, 2.35), (0.5, 3.95)],                     # lifted leg, foot flexed
        [(0, 0.72), (1.75, 0.5), (3.45, 0.42)],                     # other leg long
        [(-2.5, 0.68), (-1.5, 1.15), (-0.55, 1.7)],
    ],
    "props": [[(-0.55, 1.7), (0.5, 3.95)],                          # towel around the foot
              [(-0.35, 1.58), (0.66, 3.86)]],
    "ground": True,
}

POSES["figure4_supine"] = {
    "head": (-2.95, 0.85),
    "paths": [
        [(-2.4, 0.72), (-1.95, 0.7), (0.1, 0.75)],
        [(0.1, 0.75), (1.2, 2.2), (0.1, 3.0)],                      # bottom thigh to the chest
        [(0.1, 0.75), (1.95, 1.45), (0.7, 1.6)],                    # ankle over the knee
        [(-1.95, 0.7), (-0.75, 1.6), (0.55, 2.35)],                 # arm through the gap
    ],
    "ground": True,
}
...
POSES["knees_chest"] = {
    "head": (-2.75, 0.85),
    "paths": [
        [(-2.2, 0.72), (-1.75, 0.7), (0.2, 0.75)],
        [(0.2, 0.75), (0.9, 2.0), (-0.35, 2.5)],                    # both knees hugged in
        [(0.2, 0.62), (1.15, 1.8), (-0.1, 2.35)],
        [(-1.75, 0.7), (-0.85, 1.6), (0.05, 2.15)],
    ],
    "ground": True,
}
...
POSES["rest"] = {
    "head": (-3.6, 0.85),
    "paths": [
        [(-3.0, 0.72), (-2.5, 0.7), (0, 0.68)],                     # nothing to do
        [(0, 0.68), (1.9, 0.55), (3.7, 0.45)],
        [(0.05, 0.55), (1.95, 0.42), (3.75, 0.32)],
        [(-2.5, 0.7), (-1.6, 0.3), (-0.7, 0.2)],                    # arms a little away
    ],
    "ground": True,
}
...
POSES["plank_hold"] = {
    "head": (1.0, 2.65),
    "paths": [
        [(0.7, 2.55), (0, 2.4), (-2.7, 1.85)],
        [(0, 2.4), (0.05, 1.3), (0.05, 0.12)],                      # elbow under shoulder
        [(0.05, 0.15), (0.85, 0.12), (1.5, 0.1)],                   # forearms parallel
        [(-0.22, 2.35), (-0.18, 1.28), (-0.15, 0.12)],
        [(-0.15, 0.12), (0.65, 0.1), (1.3, 0.08)],
        [(-2.7, 1.85), (-4.4, 1.15), (-6.0, 0.5), (-6.4, 0.12)],
    ],
    "ground": True,
}
...
STATIC = [
    ...
    # standing / lunging
    "runners_lunge", "low_lunge_opener", "low_lunge_reach", "half_splits",
    "lizard", "pyramid", "side_angle", "reverse_warrior", "reverse_triangle",
    "star", "wide_leg_fold", "ragdoll", "standing_split", "warrior3",
    "figure4_standing", "standing_side_bend", "standing_backbend", "neck_side",
    "wall_chest",
    # floor
    "thread_needle", "straddle_fold", "supine_ham", "figure4_supine",
    "knees_chest", "rest", "plank_hold",
]
